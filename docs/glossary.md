...
| Iteration | A sprint or a release: a name and dates. Closing it freezes what it contains for good and produces a report |
| Swimlanes | The board sliced into rows by assignee, label, iteration or priority. A slice of the same board, not another board |
