...
| Root, leaf | The top of a tree of subtasks — an epic, say — and the cards at its bottom that have no parts of their own. A card with grandchildren counts "all told" by leaves; **By epic** puts a task into its epic's lane |
