...
- `board version` — какая это версия; отвечает и тогда, когда база
  недоступна.
- `board doctor` — проверка того, что установка сделана правильно:
...
- Вложений в карточках нет; `STORAGE` заложен на будущее и ни на что
  не влияет.
