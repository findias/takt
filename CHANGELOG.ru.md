...
- **Перенос из таблицы.** «Перенести задачи из таблицы…» под формой
  новой доски принимает CSV из Excel, Google Таблиц или выгрузки
  другого трекера, предлагает, в какое поле карточки ляжет каждая
...
<!-- перевод: CHANGELOG.md sha256:92fe94c8616a -->
