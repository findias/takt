...
- **Перенос из YouGile.** Тот же экран берёт доску YouGile по его API:
  ...
  увидеть, что получится. Переезжают задачи, колонки, исполнители
  по почте, дедлайны, даты, стикеры метками и чек-листы; что не
  переезжает — архив YouGile, пока подзадачи, чаты, файлы, права, учёт
  времени, — перечислено до переноса.
...
<!-- перевод: CHANGELOG.md sha256:2a0feb4cc567 -->
