...
- **Перенос из YouGile.** Тот же экран берёт доску YouGile по его API:
  ...
  до переноса. Людей перенос не заводит: их заводит администратор,
  и повторный перенос проставляет их в уже переехавшие карточки.
...
<!-- перевод: CHANGELOG.md sha256:998af9d7566d -->
