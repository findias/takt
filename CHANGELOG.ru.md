...
**Семь миграций, все безопасны для работающей версии.** `0052` даёт
...
уведомлений человек выключил. Идут хуком `pre-upgrade`,
...
- **Уведомления.** Колокольчик в шапке считает непрочитанное: вас
  ...
  на карточку, заблокировали вашу карточку, блокировка снялась по сроку.
...
<!-- перевод: CHANGELOG.md sha256:36cbe5591e72 -->
