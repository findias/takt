...
**Три миграции, все безопасны для работающей версии.** `0052` даёт
меткам область, `0053` — срок блокировке, `0054` переписывает служебные
функции, на которых стоят политики доступа. Идут хуком `pre-upgrade`,
...
<!-- перевод: CHANGELOG.md sha256:ae4d88437154 -->
