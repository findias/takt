...
**Четыре миграции, все безопасны для работающей версии.** `0052` даёт
...
демо и позволяет удалить организацию целиком. Идут хуком `pre-upgrade`,
...
<!-- перевод: CHANGELOG.md sha256:05a18f49ab61 -->
