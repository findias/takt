...
**Шесть миграций, все безопасны для работающей версии.** `0052` даёт
...
получателю и только пока ему видна доска. Идут хуком `pre-upgrade`,
...
<!-- перевод: CHANGELOG.md sha256:2aa99873420d -->
