...
// MaxRows — сколько строк переносим за раз. Перенос идёт одной
// транзакцией, пока человек ждёт ответа; больше — работа для фона,
// а её пока нет (ROADMAP 23.1). Предел называется в отказе числом,
// чтобы было ясно, на сколько частей делить файл.
const MaxRows = 5000
