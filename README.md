...
Как вести работу на доске — [`docs/для-команды.md`](docs/для-команды.md);
как настроить организацию, права и интеграции —
[`docs/для-владельца.md`](docs/для-владельца.md); этот файл — для того,
кто ставит и держит.
