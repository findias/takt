...
import { ALL_SECTIONS, loadLang, loadSections } from '../i18n/index.ts'
await loadLang('ru')
// Экраны в проверках монтируются напрямую, мимо `lazy`, — их разделы
// каталога грузятся здесь, все сразу.
