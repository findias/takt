...
export const hintText: typeof ru = {
  ...
  iteration: 'A sprint or a release: a name and dates that cards are attached to. After its last day it closes itself, freezes what it contains and produces a report; unfinished work is moved to the next one.',
  ...
  subdivisionAdmin: 'Runs their own subtree: who is in it, nested subdivisions and their boards; invites people and appoints owners below. Appointed by the organisation owner or the owner of a subdivision above.',
  ...
  grouping: 'The board sliced into rows by assignee, label, iteration, priority or the work tree — parent or epic. A slice of the same board: to move a card to another lane, change its property.',
  attention: 'One list of what keeps work from moving: blocked cards, work older than the board’s promise, columns over their limit and cards of iterations that have ended. Each row leads to where it is dealt with. When nothing is stuck, the panel is not shown.',
  notifications: 'The bell collects what concerns you: you were mentioned or assigned, your work was blocked, a block’s deadline is near, work went past the board’s promise. Reasons you do not need are switched off in your personal settings, on the «Notifications» tab.',
  tasks: 'One person’s cards from every board you can see, in one table: what is in progress, what waits and what is blocked. A task opens on the side without leaving this screen.',
}
