...
export type Member = {
  ...
  /** Может ли спрашивающий стереть данные этого человека: владелец
   *  организации — любого, владелец подразделения — того, кто весь
   *  внутри его поддерева. Отвечает база. */
  erasable?: boolean
}
...
export type BoardInfo = {
  ...
  writable?: boolean
  /** Может ли спрашивающий удалить доску или её карточку насовсем:
   *  владелец организации или владелец подразделения доски. Приходит
   *  в снимке и в архиве досок. */
  canPurge?: boolean
