...
export function BoardAccess({
  ...
  return (
    <div className="access stack">
      ...
      {/* Состав закрытой доски политика показывает целиком одному
          владельцу организации, остальным — их собственную строку.
          Без этой оговорки список из одного человека читался как весь
