...
var исходники = []источник{
	...
	// Формат пакета переноса — для тех, кто собирает пакеты сам или
	// проверяет, что несут через периметр.
	{"docs/import-package.md", "Import package"},
	// Выгрузчик — тем, кто собирает пакет снаружи закрытого контура.
	{"docs/takt-fetch.md", "takt-fetch"},
...
var русские = []источник{
	...
	{"docs/ru/пакет-переноса.md", "Пакет переноса"},
	{"docs/ru/выгрузчик.md", "Выгрузчик"},
}
